...
<div class="col-md-12">
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <button style="display: none;" class="btn btn-success pull-right"
    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-md-3 col-xs-6 col-xlg-2">
            ...
            <div class="hero-widget well well-sm height-abg">
                <div class="mdjc">
                    <label
                        class="text-muted"><strong><?php echo display('table');?>:<?php echo $onprocess->tablename;?></strong></label>
                ...
                <p class="m-0">
                    <label
                        class="text-muted"><?php echo display('waiter');?>:<?php echo $onprocess->first_name.' '.$onprocess->last_name;?></label>
                </p>
                <?php 
                                          $diff=0;
                ...
                <div>
                    ...
                    <a href="javascript:;"
                        ...
                        data-original-title="Pos Invoice"><i class="fa fa-window-maximize"></i></a>&nbsp;<a
                        ...
                        data-original-title="Due Invoice"><i class="fa fa-window-restore"></i></a>
                </div>
            ...
            <div class="hero-widget well well-sm height-auto">
                <div class="mdjc">
                    ...
                    <div class="display-flex align-items-center">
                        <div class=""><a href="javascript:;"
                                ...
                                id="table-<?php echo $onprocess->order_id;?>"><i class="fa fa-pencil"></i></a></div>
                ...
                <div>
                    ...
                    <a href="javascript:;" onclick="createMargeorder(<?php echo $onprocess->order_id;?>,1)"
                        class="btn btn-xs btn-success btn-sm mr-1" data-toggle="tooltip" data-placement="left" title=""
                        data-original-title="Pos Invoice"><i class="fa fa-window-maximize"></i></a>&nbsp;<a
                        href="javascript:;" class="btn btn-xs btn-success btn-sm mr-1 due_print" data-toggle="tooltip"
