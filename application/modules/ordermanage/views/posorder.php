        ...
        <div class="panel-body">
            <div class="tabsection"> <span class="display-none"><?php echo $settinginfo->language;?></span>
                <ul class="nav nav-tabs mb-2" role="tablist">
                    <li><a href="<?php echo base_url() ?>dashboard/home" class="maindashboard"><i
                                class="fa fa-home"></i></a></li>
                    <li class="active"> <a href="#home" role="tab" data-toggle="tab" title="New Order"
                    ...
                    <li class="seelist2"> <a href="#qrorder" role="tab" data-toggle="tab" id="todayqrorder"
                            class="home newtab" onclick="giveselecttab(this)"><i class="fa fa-qrcode smallview"></i>
                            <span class="responsiveview"><?php echo display('qr-order');?></span> </a> <a href=""
                    ...
                    <li class="seelist"> <a href="#settings" role="tab" data-toggle="tab" class="comorder newtab"
                            id="todayonlieorder" onclick="giveselecttab(this)"><i
                                class="fa fa-shopping-bag smallview"></i> <span
		  ...
		  ?><li class="mobiletag">
                    ...
                    <li class="mobiletag"><a href="javascript:;" class="btn" onclick="closeopenresister()"
                            role="button"><i class="fa fa-window-close fa-lg"></i></a></li>
                ...
                <div class="tab-pane fade active in" id="home">
                    <div class="row">
							   ...
							   if(!empty($category->sub)){
							    ?>
                                                    <div class="listcat dropdown cat-nav">
                                                        <button class="btn dropdown-toggle listcat listcat2"
                                                            ...
                                                            <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3 col-p-3">
                                                                <div
                                                                    ...
                                                                    <div class="panel-footer">
                                                                        <span><?php echo $item->ProductName;?>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <button type="button" class="btn btn-primary ml-l"
                                                            ...
                                                            data-target="#client-info"><i class="ti-plus"></i></button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 form-group">
                        ...
                        if($cart = $this->cart->contents()){?>
                                ...
                                ?><a class="serach pl-15" onclick="itemnote('<?php echo $item['rowid']?>','<?php echo $item['itemnote']?>',<?php echo $item['qty'];?>,2)"
                                                ...
                                                <div class="row d-flex flex-wrap align-items-center">
                                                    <div class="col-sm-6 leftview">
                                                        ...
                                                        <table class="table table-bordered footersumtotal">
                                                                    ...
                                                                    <label class="col-sm-6 p-0 mb-0">
                                                                        ...
                                                                        <span
                                                                            class="badge badge-primary grandbg font-26"><strong>
                                                                                <?php if($currency->position==1){echo $currency->curr_icon;}?>
                                                                                <span
                                                                                    id="caltotal"><?php echo $calvat+$itemtotal+$servicetotal-($discount+$pdiscount);?></span>
                                                                                <?php if($currency->position==2){echo $currency->curr_icon;}?>
                                                                            </strong></span></label>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td><label for="date"
                                                                        class="col-sm-8 mb-0"><?php echo display('service_chrg')?>
                                                    ...
                                                    <div class="col-sm-6 text-right"> <a class="btn btn-primary cusbtn"
