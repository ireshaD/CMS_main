...
<nav class="navbar navbar-static-top">
	...
	if(($title=='Home')){
	?>
        <a href="<?php echo base_url("ordermanage/order/pos_invoice") ?>" class="btn btn-success btn-outline"><i
                class="fa fa-plus"></i> <?php echo display('pos_invoice') ?></a>
        <a href="<?php echo base_url("ordermanage/order/orderlist") ?>" class="btn btn-success btn-outline"><i
                class="fa fa-list"></i> <?php echo display('order_list') ?></a>
        <a href="<?php echo base_url("ordermanage/order/allkitchen") ?>" class="btn btn-success btn-outline"><i
                class="fa fa-user-o" aria-hidden="true"></i> <?php echo display('kitchen_dashboard') ?></a>
        <a href="<?php echo base_url("ordermanage/order/counterboard") ?>" class="btn btn-success btn-outline"><i
                class="fa fa-th"></i> <?php echo display('counter_dashboard') ?></a>
        <?php } } ?>
    </span>
    <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            <!-- Order Alert -->
            <?php if ($new_version>$myversion) {if($versioncheck->version!=$new_version){ ?><li><a
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu lang_options" style="display: none;">
                    <?php 
                    $lii=0;
