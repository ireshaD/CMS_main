        ...
        ************************************* -->
        ...
        <li
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="<?php echo base_url('dashboard/role/role_list') ?>"><?php echo display('role_list')?></a>
                </li>
                <li><a
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="setting")?"active":null) ?>">
            ...
            <ul class="treeview-menu">
                ...
                <!-- <li><a href="<?php echo base_url('dashboard/rating') ?>"><?php echo display('customer_rating')?></a>
                </li>
        ...
        <li class="treeview <?php echo (($this->uri->segment(2)=="message")?"active":null) ?>">
            ...
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url('dashboard/message/new_message') ?>"><?php echo display('new')?></a>
                </li>
