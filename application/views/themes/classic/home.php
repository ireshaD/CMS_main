                ...
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <?php $tm = 0;
                        foreach ($todaymenu_menu as $tmenu) {
                            $tm++;
                            if($tmenu->menutype !="Cart"){ ?>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link <?php if ($tm == 1) {echo "active";} ?>"
                            id="pills-home-tab<?php echo $tm; ?>" data-toggle="pill"
                            href="#pills-<?php echo $tmenu->menutypeid; ?>"
                            onclick="showfood(<?php echo $tmenu->menutypeid; ?>)">
                            <img src="<?php echo base_url(!empty($tmenu->menu_icon) ? $tmenu->menu_icon : 'assets/img/icons/default.jpg'); ?>"
                                alt="">
    ...
    <div class="container">
        <div class="row reservation-inner">
            <div class="col-xl-5 col-lg-6 show-lg">
                ...
                <img src="<?php echo base_url(!empty($reslider->image) ? $reslider->image : 'dummyimage/470x548.jpg'); ?>"
                    class="img-fluid" alt="">
                <?php } ?>
            </div>
                ...
                <form class="main-reservaton-form" action="#" method="post">
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            ...
                            <input type="text" name="reservation_person" id="reservation_person"
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <input type="text" name="reservation_contact" id="reservation_contact"
                        ...
                        <div class="col-lg-12">
                            ...
                            <button type="button" class="simple_btn"
                                onclick="checkavailablity()"><?php echo display('book_table')?></button>
                        </div>
                    </div>
                </form>
            </div>
