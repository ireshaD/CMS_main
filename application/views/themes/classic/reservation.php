                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <input type="text" name="reservation_person" id="reservation_person"
                            placeholder="<?php echo display('reservation_person')?>" autocomplete="off">
                    </div>
                    <div class="col-lg-12 mb-4">
                        <label for="reservation_date"><i class="ti-calendar"></i></label>
                        <input type="text" name="reservation_date" id="reservation_date"
                            placeholder="<?php echo display('reservation_date')?>" class="datepickerreserve"
                            autocomplete="off">
                    </div>
                    <div class="col-lg-12 mb-4">
                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <input type="text" name="reservation_contact" id="reservation_contact"
                            placeholder="<?php echo display('reservation_contact')?>" autocomplete="off">
                    </div>
                    <div class="col-lg-12">
