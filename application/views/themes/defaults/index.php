...
<body>
    ...
    <header class="header_top_area">
                    ...
                    <div class="sidebar-toggle-btn">
                        <a class="nav-link nav_link_in" href="<?php echo base_url(); ?>cart" id="navbarDropdown3">
                            <i class="ti-shopping-cart"></i><span
                                class="badge badge-notify my-cart-badge badge_color_in"><?php $totalqty = 0; if($this->cart->contents() > 0){$totalqty = count($this->cart->contents());} echo $totalqty; ?></span>
                        </a>
        ...
        <!--START SLIDER PART-->
        <div class="main_slider owl-carousel" style="display: none;">
